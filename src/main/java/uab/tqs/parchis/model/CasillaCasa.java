...
/**
 * Representa una casilla "casa" en un tablero de Parchís, donde las fichas inician su recorrido.
 * 
 * Invariante:
...
public class CasillaCasa implements Casilla {
    ...
    /**
     * Constructor de la casilla casa.
     * 
     * Precondiciones:
     ...
     * 
     * Postcondiciones:
     * - Devuelve siempre `false`, ya que las casillas casa no pueden estar bloqueadas.
     * 
     * @return `false`.
     */
    @Override
     ...
     * 
     * Postcondiciones:
     * - Devuelve siempre `true`, ya que las casillas casa son seguras.
     * 
     * @return `true`.
     */
    @Override
    ...
    public String toString() {
        StringBuilder mensaje = new StringBuilder("CasillaCasa: Inicio (número: " + numero + "), Fichas: ");
